...
class Mmdet3dNode(Node):
    def __init__(self):
        ...
        self.declare_parameter('penetration_threshold', 0.7)   #穿透到目标后方的点数占比的多少时，认为该目标已不存在。
        self.declare_parameter('penetration_confirm_frames_threshold', 5)    # 穿透连续多少帧认为才是真的消失了
